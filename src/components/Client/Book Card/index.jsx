...
export default function BookCard({ book }) {
    ...
    function handleFavorites(book) {
        let findFavs = favorites.find(favorite => favorite.id == book.id )
        if (findFavs) {
            alert("Bu kitab sizin favorites sehifenizde movcuddur");
        } else {
        ...
        <Card key={book.id}>
            ...
            <Card.Body>
                ...
                <div className="buttons flex gap-2">
                    ...
                    <Button variant="danger" className='p-2' onClick={() => handleFavorites(book)}>
